...
def prepare():
    ...
    baseline.dump(OUT/'manifest.json', dict(baseline_sha256=baseline.sha(BASELINE/'baseline_manifest.json'),
        ...
        protocol_sha256=baseline.sha(ROOT/'docs/superpowers/plans/2026-09-19-full-project.md'),
...
def check():
    ...
    assert manifest['protocol_sha256'] == baseline.sha(ROOT/'docs/superpowers/plans/2026-09-19-full-project.md')
